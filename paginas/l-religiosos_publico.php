...
<body>
    <header>
        ...
        <section class="p-desk">
            ...
            <a href="l-religiosos_publico.php" class="selected religiosos"><div class="icone"><img src="../imagens/crosssign.png" class="icone" alt=""></div><span>L. Religiosos</span></div></a>
        </section>
    </header>
    <main>
        <section class="caixa">
            ...
            <div class="cadastrar radius">
                ...
                <div class="pesquisa">
                    <form action="search-religiosos_publico.php" method="post">
                        <div class="campos">
