...
<head>
    ...
    <title>Associação NACAJ | Lideres Religiosos</title>
...
<header>
    ...
    <section class="opcoes">
        ...
        <div class="lista active">
            ...
            <a href="l-religiosos.php" class="selected"><img src="../imagens/crosssign.png" class="icone" alt=""><span>Religiosos</span></a>
        </div>
    </section>
    <section class="p-desk">
        ...
        <a href="l-religiosos.php" class="selected religiosos"><div class="icone"><img src="../imagens/crosssign.png" class="icone" alt=""></div><span>L. Religiosos</span></div></a>
    </section>
</header>
    <main>
        <section class="caixa">
            <div class="cadastrar radius">
                ...
                <div class="pesquisa">
                    <form action="search-religiosos.php" method="post">
                        <div class="campos">
